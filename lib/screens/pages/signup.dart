...
import 'package:AgriNet/widget/changescreen.dart';
import 'package:AgriNet/widget/mybutton.dart';
import 'package:AgriNet/widget/mytextformfield.dart';
import 'package:AgriNet/widget/passwordtextformfield.dart';
...
class _SignUpState extends State<SignUp> {
  ...
  void validation() async {
    if (userName.text.isEmpty &&
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar( content: Text("All Flied Are Empty"),
        ),
      );
    } else if (userName.text.length < 6) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar( content: Text("Name Must Be 6 "),
        ),
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar( content: Text("Please Try Vaild Email"),
        ),
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar( content: Text("Phone Number Must Be 11 "),
        ),
      );
